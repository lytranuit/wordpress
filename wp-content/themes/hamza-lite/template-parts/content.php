...
//die();
?>
<article id="post-<?php the_ID(); ?>" <?php post_class("col-xs-12 col-md-6"); ?> data-animate-scroll='{"alpha": "0", 
         "duration": "<?php echo rand(5, 10) / 10; ?>",
         "rotationY":"45",
         "z":"-30"}'>
        ...
        <div class="entry-exrecpt">
            <div class="short-content clearfix">
                ...
                <div class="details-wp">
                    <div class="dtich" style="display:inline-block;margin-right: 10%;">
                        <label>
                            DT:
                        </label>
                        <span>
                    ...
                    <div class="gia" style="display:inline-block;">
                        <label>
                            Giá:
                        </label>
                        <span>
