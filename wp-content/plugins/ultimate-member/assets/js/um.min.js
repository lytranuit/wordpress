            ...
            i.x = a.pageX, i.y = a.pageY
                ...
                if (d = c.element, "select" === d.get(0).tagName.toLowerCase() && (this.select = e = c.element), e && a.each(["id", "multiple", "ajax", "query", "createSearchChoice", "initSelection", "data", "tags"], function() {
                    if (this in c)
                        ...
                        h = function(d, e, l) {
                            ...
                            for (d = c.sortResults(d, e, f), m = 0, n = d.length; n > m; m += 1)
                ...
                if ((c === !0 || !k || !r(j, k)) && (a.data(this.container, "select2-last-term", j), c === !0 || this.showSearchInput !== !1 && this.opened())) {
                    ...
                    if (o >= 1 && (g = this.data(), a.isArray(g) && g.length >= o && J(f.formatSelectionTooBig, "formatSelectionTooBig")))
                        return n("<li class='select2-selection-limit'>" + K(f.formatSelectionTooBig, o) + "</li>"), void 0;
                    if (d.val().length < f.minimumInputLength)
                        return J(f.formatInputTooShort, "formatInputTooShort") ? n("<li class='select2-no-results'>" + K(f.formatInputTooShort, d.val(), f.minimumInputLength) + "</li>") : n(""), c && this.showSearch && this.showSearch(!0), void 0;
                    if (f.maximumInputLength && d.val().length > f.maximumInputLength)
                        return J(f.formatInputTooLong, "formatInputTooLong") ? n("<li class='select2-no-results'>" + K(f.formatInputTooLong, d.val(), f.maximumInputLength) + "</li>") : n(""), void 0;
                    f.formatSearching && 0 === this.findHighlightableChoices().length && n("<li class='select2-searching'>" + K(f.formatSearching) + "</li>"), d.addClass("select2-active"), this.removeHighlight(), i = this.tokenize(), i != b && null != i && d.val(i), this.resultsPage = 1, f.query({element: f.element, term: d.val(), page: this.resultsPage, context: null, matcher: f.matcher, callback: this.bind(function(g) {
                            ...
                            if (l == this.queryCount) {
                                ...
                                if (this.context = g.context === b ? null : g.context, this.opts.createSearchChoice && "" !== d.val() && (i = this.opts.createSearchChoice.call(h, d.val(), g.results), i !== b && null !== i && h.id(i) !== b && null !== h.id(i) && 0 === a(g.results).filter(function() {
                                    ...
                                    return n("<li class='select2-no-results'>" + K(f.formatNoMatches, d.val()) + "</li>"), void 0;
...
(function(b) {
    typeof define === "function" && define.amd ? define(["jquery"], b) : b(typeof jQuery != "undefined" ? jQuery : window.Zepto)
})(function(b) {
    function O(a) {
        var g = a.data;
        if (!a.isDefaultPrevented()) {
            a.preventDefault();
            b(a.target).ajaxSubmit(g)
        }
    }
    function P(a) {
        var g = a.target, k = b(g);
        if (!k.is("[type=submit],[type=image]")) {
            g = k.closest("[type=submit]");
            if (g.length === 0)
                return;
            g = g[0]
        }
        ...
        if (g.type == "image")
            if (a.offsetX !== undefined) {
                ...
                e.clk_y = a.offsetY
                    ...
                    "function") {
                k = k.offset();
                e.clk_x = a.pageX - k.left;
                e.clk_y = a.pageY - k.top
            } else {
                e.clk_x = a.pageX - g.offsetLeft;
                e.clk_y = a.pageY - g.offsetTop
            }
        setTimeout(function() {
    ...
    var K = {};
    K.fileapi = b("<input type='file'/>").get(0).files !== undefined;
    K.formdata = window.FormData !==
            undefined;
    var S = !!b.fn.prop;
    b.fn.attr2 = function() {
        if (!S)
    ...
    b.fn.ajaxSubmit = function(a) {
        function g(l) {
            l = b.param(l, a.traditional).split("&");
            var w = l.length, p = [], t, n;
            for (t = 0; t < w; t++) {
                l[t] = l[t].replace(/\+/g, " ");
                n = l[t].split("=");
                p.push([decodeURIComponent(n[0]), decodeURIComponent(n[1])])
            }
            return p
        }
        function k(l) {
            for (var w = new FormData, p = 0; p < l.length; p++)
                w.append(l[p].name,
                        l[p].value);
            if (a.extraData) {
                l = g(a.extraData);
                for (p = 0; p < l.length; p++)
                    l[p] && w.append(l[p][0], l[p][1])
            }
            a.data = null;
            p = b.extend(true, {}, b.ajaxSettings, a, {contentType: false, processData: false, cache: false, type: i || "POST"});
            if (a.uploadProgress)
                p.xhr = function() {
                    var n = b.ajaxSettings.xhr();
                    n.upload && n.upload.addEventListener("progress", function(r) {
                        var c = 0, B = r.loaded || r.position, G = r.total;
                        if (r.lengthComputable)
                            c = Math.ceil(B / G * 100);
                        a.uploadProgress(r, B, G, c)
                    }, false);
                    return n
                };
            p.data = null;
            ...
            p.beforeSend =
                    function(n, r) {
                        r.data = a.formData ? a.formData : w;
                        t && t.call(this, n, r)
                    };
            return b.ajax(p)
        }
        function e(l) {
            function w(f) {
                ...
                try {
                    if (f.contentWindow)
                        j = f.contentWindow.document
                } catch (x) {
                    u("cannot get iframe.contentWindow document: " + x)
                }
                if (j)
                    return j;
                try {
                    j = f.contentDocument ? f.contentDocument : f.document
                } catch (y) {
                    u("cannot get iframe.contentDocument: " + y);
                    j = f.document
                }
                return j
            }
            function p() {
                function f() {
                    try {
                        var H = w(z).readyState;
                        u("state = " + H);
                        H && H.toLowerCase() == "uninitialized" && setTimeout(f, 50)
                    } catch (I) {
                        u("Server abort: ",
                                I, " (", I.name, ")");
                        t(Q);
                ...
                var j = o.attr2("target"), x = o.attr2("action"), y = o.attr("enctype") || o.attr("encoding") || "multipart/form-data";
                n.setAttribute("target", G);
                if (!i || /post/i.test(i))
                    n.setAttribute("method", "POST");
                x != c.url && n.setAttribute("action", c.url);
                if (!c.skipEncodingOverride && (!i || /post/i.test(i)))
                ...
                try {
                    if (c.extraData)
                        for (var A in c.extraData)
                            if (c.extraData.hasOwnProperty(A))
                                b.isPlainObject(c.extraData[A]) &&
                                        c.extraData[A].hasOwnProperty("name") && c.extraData[A].hasOwnProperty("value") ? C.push(b('<input type="hidden" name="' + c.extraData[A].name + '">').val(c.extraData[A].value).appendTo(n)[0]) : C.push(b('<input type="hidden" name="' + A + '">').val(c.extraData[A]).appendTo(n)[0]);
                    c.iframeTarget || D.appendTo("body");
                    z.attachEvent ? z.attachEvent("onload", t) : z.addEventListener("load", t, false);
                    setTimeout(f, 15);
                    try {
                        n.submit()
                    } catch (M) {
                    ...
                    n.setAttribute("action", x);
                    n.setAttribute("enctype", y);
                    j ? n.setAttribute("target", j) : o.removeAttr("target");
                    b(C).remove()
                }
            }
            function t(f) {
                if (!(d.aborted || U)) {
                    v = w(z);
                    if (!v) {
                        u("cannot access response document");
                        f = Q
                    }
                    if (f === T && d) {
                        d.abort("timeout");
                        ...
                        E.reject(d, "error", "server abort")
                    } else {
                        if (!v || v.location.href == c.iframeSrc)
                            if (!R)
                                return;
                        ...
                        try {
                            if (R)
                                throw"timeout";
                            var x = c.dataType ==
                                    "xml" || v.XMLDocument || b.isXMLDoc(v);
                            u("isXml=" + x);
                            if (!x && window.opera && (v.body === null || !v.body.innerHTML))
                                if (--X) {
                                    u("requeing onLoad callback, DOM not available");
                                    setTimeout(t, 250);
                                    return
                                }
                            var y = v.body ? v.body : v.documentElement;
                            d.responseText = y ? y.innerHTML : null;
                            d.responseXML = v.XMLDocument ? v.XMLDocument : v;
                            if (x)
                                c.dataType = "xml";
                            d.getResponseHeader = function(Y) {
                                return{"content-type": c.dataType}[Y.toLowerCase()]
                            };
                            if (y) {
                                d.status = Number(y.getAttribute("status")) || d.status;
                                d.statusText = y.getAttribute("statusText") ||
                                        d.statusText
                            }
                            var C = (c.dataType || "").toLowerCase(), A = /(json|script|text)/.test(C);
                            if (A || c.textarea) {
                                var M = v.getElementsByTagName("textarea")[0];
                                if (M) {
                                    d.responseText = M.value;
                                    d.status = Number(M.getAttribute("status")) || d.status;
                                    d.statusText = M.getAttribute("statusText") || d.statusText
                                } else if (A) {
                                    var H = v.getElementsByTagName("pre")[0], I = v.getElementsByTagName("body")[0];
                                    if (H)
                                        d.responseText = H.textContent ? H.textContent : H.innerText;
                                    else if (I)
                                        d.responseText = I.textContent ? I.textContent : I.innerText
                                }
                            } else if (C ==
                                    "xml" && !d.responseXML && d.responseText)
                        ...
                        if (d.status)
                            f = d.status >= 200 && d.status < 300 || d.status === 304 ? "success" : "error";
                        if (f === "success") {
                            c.success && c.success.call(c.context, V, "success", d);
                            E.resolve(d.responseText, "success", d);
                            B && b.event.trigger("ajaxSuccess", [d, c])
                        } else if (f) {
                            if (j === undefined)
                                j = d.statusText;
                            c.error && c.error.call(c.context,
                                    d, f, j);
                            E.reject(d, "error", j);
                            B && b.event.trigger("ajaxError", [d, c, j])
                        }
                        B && b.event.trigger("ajaxComplete", [d, c]);
                        B && !--b.active && b.event.trigger("ajaxStop");
                        c.complete && c.complete.call(c.context, d, f);
                        U = true;
                        c.timeout && clearTimeout(L);
                        setTimeout(function() {
                            c.iframeTarget ? D.attr("src", c.iframeSrc) : D.remove();
                            d.responseXML = null
                        }, 100)
                    }
                }
            }
            var n = o[0], r, c, B, G, D, z, d, R, L, E = b.Deferred();
            E.abort = function(f) {
                d.abort(f)
            };
            if (l)
                for (r = 0; r < s.length; r++) {
                    l = b(s[r]);
                    S ? l.prop("disabled", false) : l.removeAttr("disabled")
                }
            c =
                    b.extend(true, {}, b.ajaxSettings, a);
            ...
            if (c.iframeTarget) {
                ...
                D = b('<iframe name="' + G + '" src="' + c.iframeSrc + '" ></300>');
                D.css({position: "absolute", top: "-1000px", left: "-1000px"})
            }
            z = D[0];
            d = {aborted: 0, responseText: null, responseXML: null, status: 0, statusText: "n/a", getAllResponseHeaders: function() {
                    ...
                    this.aborted = 1;
                    try {
                        z.contentWindow.document.execCommand && z.contentWindow.document.execCommand("Stop")
                    } catch (x) {
                    }
                    D.attr("src", c.iframeSrc);
                    d.error = j;
                    c.error && c.error.call(c.context, d, j, f);
                    B && b.event.trigger("ajaxError", [d, c, j]);
                    c.complete && c.complete.call(c.context, d, j)
                }};
            (B = c.global) && 0 === b.active++ && b.event.trigger("ajaxStart");
            B && b.event.trigger("ajaxSend", [d, c]);
            if (c.beforeSend && c.beforeSend.call(c.context, d, c) === false) {
                c.global && b.active--;
                E.reject();
                return E
            }
            ...
            if (l = n.clk)
                if ((r = l.name) && !l.disabled) {
                    c.extraData = c.extraData || {};
                    c.extraData[r] = l.value;
                    if (l.type == "image") {
                        c.extraData[r + ".x"] = n.clk_x;
                        c.extraData[r + ".y"] = n.clk_y
                    }
                }
            var T = 1, Q = 2;
            l = b("meta[name=csrf-token]").attr("content");
            if ((r = b("meta[name=csrf-param]").attr("content")) && l) {
                c.extraData = c.extraData || {};
                c.extraData[r] = l
            }
            c.forceSync ? p() : setTimeout(p, 10);
            var V, v, X = 50, U, Z = b.parseXML || function(f, j) {
                ...
                return j && j.documentElement && j.documentElement.nodeName != "parsererror" ? j : null
            }, ba = b.parseJSON || function(f) {
                return window.eval("(" + f + ")")
            }, $ = function(f, j, x) {
                var y = f.getResponseHeader("content-type") || "", C = j === "xml" || !j && y.indexOf("xml") >= 0;
                f = C ? f.responseXML : f.responseText;
                C && f.documentElement.nodeName === "parsererror" && b.error && b.error("parsererror");
                if (x && x.dataFilter)
                    f = x.dataFilter(f, j);
                if (typeof f === "string")
                    if (j ===
                            "json" || !j && y.indexOf("json") >= 0)
                        f = ba(f);
                    else if (j === "script" || !j && y.indexOf("javascript") >= 0)
                        b.globalEval(f);
                return f
            };
            return E
        ...
        if (!this.length) {
            u("ajaxSubmit: skipping submit process - no element selected");
            return this
        }
        var i, h, o = this;
        ...
        h = a.url || this.attr2("action");
        if (h = (h = typeof h === "string" ? b.trim(h) : "") || window.location.href || "")
            h = (h.match(/^([^#]+)/) || [])[1];
        a = b.extend(true, {url: h, success: b.ajaxSettings.success,
            type: i || b.ajaxSettings.type, iframeSrc: /^https/i.test(window.location.href || "") ? "javascript:false" : "about:blank"}, a);
        h = {};
        this.trigger("form-pre-serialize", [this, a, h]);
        if (h.veto) {
            u("ajaxSubmit: submit vetoed via form-pre-serialize trigger");
            return this
        }
        if (a.beforeSerialize && a.beforeSerialize(this, a) === false) {
            u("ajaxSubmit: submit aborted via beforeSerialize callback");
            return this
        }
        var q = a.traditional;
        if (q === undefined)
            q = b.ajaxSettings.traditional;
        var s = [], m, F = this.formToArray(a.semantic, s);
        if (a.data) {
            a.extraData =
                    a.data;
            m = b.param(a.data, q)
        ...
        if (a.beforeSubmit && a.beforeSubmit(F, this, a) === false) {
            u("ajaxSubmit: submit aborted via beforeSubmit callback");
            return this
        }
        this.trigger("form-submit-validate", [F, this, a, h]);
        if (h.veto) {
            u("ajaxSubmit: submit vetoed via form-submit-validate trigger");
            return this
        }
        h = b.param(F, q);
        if (m)
        ...
        if (a.type.toUpperCase() == "GET") {
            a.url += (a.url.indexOf("?") >= 0 ? "&" : "?") + h;
            a.data = null
        } else
            a.data = h;
        var J = [];
        a.resetForm && J.push(function() {
            o.resetForm()
        });
        a.clearForm && J.push(function() {
            o.clearForm(a.includeHidden)
        });
        if (!a.dataType && a.target) {
            var ca = a.success || function() {
            };
            J.push(function(l) {
                var w = a.replaceTarget ? "replaceWith" : "html";
                b(a.target)[w](l).each(ca, arguments)
            })
        } else
            a.success && J.push(a.success);
        a.success = function(l, w, p) {
            for (var t = a.context || this, n = 0, r = J.length; n < r; n++)
                J[n].apply(t, [l, w, p || o, o])
        };
        if (a.error) {
            var da = a.error;
            a.error = function(l, w, p) {
                da.apply(a.context || this, [l, w, p, o])
            }
        }
        if (a.complete) {
            var ea = a.complete;
            a.complete = function(l, w) {
                ea.apply(a.context || this, [l, w, o])
            }
        }
        m = b("input[type=file]:enabled",
                this).filter(function() {
            return b(this).val() !== ""
        }).length > 0;
        h = o.attr("enctype") == "multipart/form-data" || o.attr("encoding") == "multipart/form-data";
        q = K.fileapi && K.formdata;
        u("fileAPI :" + q);
        var N;
        if (a.iframe !== false && (a.iframe || (m || h) && !q))
            if (a.closeKeepAlive)
                b.get(a.closeKeepAlive, function() {
                    N = e(F)
                });
            else
                N = e(F);
        else
            N = (m || h) && q ? k(F) : b.ajax(a);
        o.removeData("jqxhr").data("jqxhr", N);
    ...
    b.fn.ajaxForm = function(a) {
        ...
        if (!a.delegation && this.length === 0) {
            ...
            if (!b.isReady && g.s) {
                u("DOM not ready, queuing ajaxForm");
                b(function() {
                    b(g.s, g.c).ajaxForm(a)
                });
                return this
            }
            u("terminating; zero elements found by selector" + (b.isReady ? "" : " (DOM not ready)"));
            return this
        }
        if (a.delegation) {
            b(document).off("submit.form-plugin", this.selector, O).off("click.form-plugin", this.selector, P).on("submit.form-plugin", this.selector, a, O).on("click.form-plugin",
                    this.selector, a, P);
            return this
        }
        return this.ajaxFormUnbind().bind("submit.form-plugin", a, O).bind("click.form-plugin", a, P)
    };
    b.fn.ajaxFormUnbind = function() {
        return this.unbind("submit.form-plugin click.form-plugin")
    };
    b.fn.formToArray = function(a, g) {
        var k = [];
        if (this.length === 0)
            return k;
        var e = this[0], i = this.attr("id"), h = a ? e.getElementsByTagName("*") : e.elements;
        if (h && !/MSIE [678]/.test(navigator.userAgent))
            h = b(h).get();
        if (i) {
            i = b(':input[form="' + i + '"]').get();
            if (i.length)
                h = (h || []).concat(i)
        }
        if (!h || !h.length)
        ...
        var o, q, s, m, F;
        o = 0;
        for (F = h.length; o < F; o++) {
            m = h[o];
            i = m.name;
            if (!(!i || m.disabled))
                if (a && e.clk && m.type == "image") {
                    if (e.clk == m) {
                        k.push({name: i, value: b(m).val(), type: m.type});
                        k.push({name: i + ".x", value: e.clk_x}, {name: i + ".y", value: e.clk_y})
                    }
                } else if ((s = b.fieldValue(m, true)) && s.constructor == Array) {
                    g && g.push(m);
                    q = 0;
                    for (m = s.length; q < m; q++)
                        k.push({name: i, value: s[q]})
                } else if (K.fileapi && m.type == "file") {
                    g && g.push(m);
                    s = m.files;
                    if (s.length)
                        for (q = 0; q < s.length; q++)
                            k.push({name: i, value: s[q], type: m.type});
                    else
                        k.push({name: i,
                            value: "", type: m.type})
                } else if (s !== null && typeof s != "undefined") {
                    g && g.push(m);
                    k.push({name: i, value: s, type: m.type, required: m.required})
                }
        }
        if (!a && e.clk) {
            h = b(e.clk);
            o = h[0];
            if ((i = o.name) && !o.disabled && o.type == "image") {
                k.push({name: i, value: h.val()});
                k.push({name: i + ".x", value: e.clk_x}, {name: i + ".y", value: e.clk_y})
            }
        }
        return k
            ...
            if (k) {
                ...
                if (e &&
                    ...
                    for (var i = 0, h = e.length; i < h; i++)
                        g.push({name: k, value: e[i]});
                else
                    e !== null && typeof e != "undefined" && g.push({name: this.name, value: e})
            }
        });
        return b.param(g)
    };
    b.fn.fieldValue = function(a) {
        for (var g = [], k = 0, e = this.length; k < e; k++) {
            var i = b.fieldValue(this[k], a);
            i === null || typeof i == "undefined" || i.constructor == Array && !i.length || (i.constructor == Array ? b.merge(g, i) : g.push(i))
        }
        return g
    };
    b.fieldValue = function(a, g) {
        var k = a.name, e = a.type, i = a.tagName.toLowerCase();
        if (g === undefined)
            g = true;
        if (g && (!k ||
                a.disabled || e == "reset" || e == "button" || (e == "checkbox" || e == "radio") && !a.checked || (e == "submit" || e == "image") && a.form && a.form.clk != a || i == "select" && a.selectedIndex == -1))
            return null;
        if (i == "select") {
            ...
            k = [];
            i = a.options;
            var o = (e = e == "select-one") ? h + 1 : i.length;
            for (h = e ? h : 0; h < o; h++) {
                var q = i[h];
                if (q.selected) {
                    var s = q.value;
                    s || (s = q.attributes && q.attributes.value && !q.attributes.value.specified ? q.text : q.value);
                    if (e)
                        return s;
                    k.push(s)
                }
    ...
    b.fn.clearFields = b.fn.clearInputs = function(a) {
        ...
        return this.each(function() {
            var k = this.type, e = this.tagName.toLowerCase();
            if (g.test(k) || e == "textarea")
                this.value = "";
                ...
                / MSIE /.test(navigator.userAgent) ? b(this).replaceWith(b(this).clone(true)) :
                        b(this).val("");
            else if (a)
                if (a === true && /hidden/.test(k) || typeof a == "string" && b(this).is(a))
                    this.value = ""
        })
    };
    ...
    b.fn.selected = function(a) {
        ...
        return this.each(function() {
            ...
            if (g == "checkbox" || g == "radio")
                this.checked = a;
            else if (this.tagName.toLowerCase() ==
                    "option") {
                g = b(this).parent("select");
                a && g[0] && g[0].type == "select-one" && g.find("option").selected(false);
                this.selected = a
            }
        })
    };
...
(function(b) {
    ...
    b.fn.uploadFile = function(t) {
        var r = b.extend({url: "", method: "POST", enctype: "multipart/form-data", formData: null, returnType: null, allowedTypes: "*", fileName: "file", formData:{}, dynamicFormData: function() {
                return{}
            }, maxFileSize: -1, maxFileCount: -1, multiple: true, dragDrop: true, autoSubmit: true, showCancel: true, showAbort: true, showDone: true, showDelete: false, showError: true, showStatusAfterSuccess: true, showStatusAfterError: true, showFileCounter: true, fileCounterStyle: "). ", showProgress: false, onSelect: function(s) {
                return true
            }, onSubmit: function(s, u) {
            }, onSuccess: function(u, s, v) {
            }, onError: function(v, s, u) {
            }, deleteCallback: false, afterUploadAll: false, uploadButtonClass: "upload", dragDropStr: "", abortStr: "Abort", cancelStr: "Cancel", deletelStr: "Delete", doneStr: "Done", multiDragErrorStr: "Multiple File Drag &amp; Drop is not allowed.", extErrorStr: "", sizeErrorStr: "", uploadErrorStr: "Upload is not allowed", maxFileCountErrorStr: ""}, t);
        this.fileCounter = 1;
        ...
        function q(y, B, D, u) {
            ...
            u.css({position: "relative", overflow: "hidden", cursor: "default"});
        ...
        function n(z, y, u, w, A) {
            var x = null;
            var v = {cache: false, contentType: false, processData: false, forceSync: false, data: y.formData, formData: y.fileData, dataType: y.returnType, beforeSubmit: function(F, C, E) {
...
!function(a) {
    ...
    function b(f, g, h, k) {
        ...
        function n() {
            w.$root.on({focusin: function(a) {
                ...
                var c = a(this), d = c.data(), e = c.hasClass(t.navDisabled) || c.hasClass(t.disabled), g = document.activeElement;
                g = g && (g.type || g.href) && g, (e || g && !a.contains(w.$root[0], g)) && f.focus(), d.nav && !e ? w.set("highlight", w.component.item.highlight, {nav: d.nav}) : b._.isInteger(d.pick) && !e ? w.set("select", d.pick).close(!0) : d.clear && w.clear().close(!0)
            }), e(w.$root[0], "hidden", !0)
        }
        function o() {
            var b, c;
        ...
        if (!f)
            return b;
        var q = !1, r = {id: f.id || "P" + Math.abs(~~(Math.random() * new Date))}, s = h ? a.extend(!0, {}, h.defaults, k) : k || {}, t = a.extend({}, b.klasses(), s.klass), u = a(f), v = function() {
            return this.start()
        }, w = v.prototype = {constructor: v, $node: u, start: function() {
                ...
                return r.open ? w : (u.addClass(t.active), e(f, "expanded", !0), setTimeout(function() {
                    ...
                    var d = c.keyCode, e = w.component.key[d], g = c.target;
                ...
                if (b) {
                    f || (g[b] = c);
                    for (d in g)
                        e = g[d], r.methods[d] = r.methods[d] || [], r.methods[d].push(e)
                }
                return w
            }, off: function() {
                var a, b, c = arguments;
    ...
    var h = a(window), i = a(document), j = a(document.documentElement);
...
!function(a) {
    ...
    function c(a, b) {
        ...
        }(c.item.disable), c.set("min", b.min).set("max", b.max).set("now"), f ? c.set("select", f, {format: g}) : c.set("select", null).set("highlight", c.item.now), c.key = {40: 7, 38: -7, 39: function() {
                return h() ? -1 : 1
            }, 37: function() {
                return h() ? 1 : -1
            }, go: function(a) {
...
!function(a) {
    ...
    function c(a, b) {
        ...
        c.settings = b, c.$node = a.$node, c.queue = {interval: "i", min: "measure create", max: "measure create", now: "now create", select: "parse create validate", highlight: "parse create validate", view: "parse create validate", disable: "deactivate", enable: "activate"}, c.item = {}, c.item.clear = null, c.item.interval = b.interval || 30, c.item.disable = (b.disable || []).slice(0), c.item.enable = -function(a) {
            return a[0] === !0 ? a.shift() : -1
        }(c.item.disable), c.set("min", b.min).set("max", b.max).set("now"), f ? c.set("select", f, {format: g, fromValue: !!d}) : c.set("select", null).set("highlight", c.item.now), c.key = {40: 1, 38: -1, 39: 1, 37: -1, go: function(a) {
    ...
    c.prototype.set = function(a, b, c) {
        ...
        var i = this;
        return c = void 0 === c ? a : c, h.isDate(c) && (c = [c.getHours(), c.getMinutes()]), b.isPlainObject(c) && h.isInteger(c.pick) ? c = c.pick : b.isArray(c) ? c = +c[0] * e + +c[1] : h.isInteger(c) || (c = i.now(a, c, f)), "max" == a && c < i.item.min.pick && (c += g), "min" != a && "max" != a && (c - i.item.min.pick) % i.item.interval !== 0 && (c += i.item.interval), c = i.normalize(a, c, f), {hour: ~~(d + c / e) % d, mins: (e + c % e) % e, time: (g + c) % g, pick: c}
    }, c.prototype.createRange = function(a, c) {
        var d = this, e = function(a) {
            return a === !0 || b.isArray(a) || h.isDate(a) ? d.create(a) : a
        };
        return h.isInteger(a) || (a = e(a)), h.isInteger(c) || (c = e(c)), h.isInteger(a) && b.isPlainObject(c) ? a = [c.hour, c.mins + a * d.settings.interval] : h.isInteger(c) && b.isPlainObject(a) && (c = [a.hour, a.mins + c * d.settings.interval]), {from: e(a), to: e(c)}
    }, c.prototype.withinRange = function(a, b) {
        return a = this.createRange(a.from, a.to), b.pick >= a.from.pick && b.pick <= a.to.pick
    }, c.prototype.overlapRanges = function(a, b) {
        var c = this;
        ...
        for (i in l)
            j = l[i], h.isInteger(j) ? i.match(/^(h|hh)$/i) ? (d = j, ("h" == i || "hh" == i) && (d %= 12)) : "i" == i && (f = j) : i.match(/^a$/i) && j.match(/^p/i) && ("h"in l || "hh"in l) && (g = !0);
        return(g ? d + 12 : d) * e + f
        ...
        return h.node("ul", h.group({min: b.item.min.pick, max: b.item.max.pick, i: b.item.interval, node: "li", item: function(a) {
                a = b.create(a);
                ...
                return[h.trigger(b.formats.toString, b, [h.trigger(c.formatLabel, b, [a]) || c.format, a]), function(a) {
                    ...
                    }([c.klass.listItem]), "data-pick=" + a.pick + " " + h.ariaAttr({role: "option", selected: j && b.$node.val() === h.trigger(b.formats.toString, b, [c.format, a]) ? !0 : null, activedescendant: k ? !0 : null, disabled: l ? !0 : null})]
            }}) + h.node("li", h.node("button", c.clear, c.klass.buttonClear, "type=button data-clear=1" + (a ? "" : " disabled") + " " + h.ariaAttr({controls: b.$node[0].id})), "", h.ariaAttr({role: "presentation"})), c.klass.list, h.ariaAttr({role: "listbox", controls: b.$node[0].id}))
    }, c.defaults = function(a) {
...
(function(e) {
    var c = {init: function(a) {
            return this.each(function() {
                ...
                this.opt = e.extend(true, {}, e.fn.raty.defaults, a);
                c._adjustCallback.call(this);
                c._adjustNumber.call(this);
                this.opt.starType !== "img" && c._adjustStarType.call(this);
            ...
            for (var a = ["number", "readOnly", "score", "scoreName", "target"], b = 0; b < a.length; b++)
                if (typeof this.opt[a[b]] === "function")
                    this.opt[a[b]] = this.opt[a[b]].call(this)
        }, _adjustNumber: function() {
            this.opt.number = c._between(this.opt.number, 1, this.opt.numberMax)
        }, _adjustPath: function() {
            this.opt.path = this.opt.path || "";
            if (this.opt.path && this.opt.path.charAt(this.opt.path.length -
                    1) !== "/")
                this.opt.path += "/"
            ...
            this.opt.path = "";
            for (var a = ["cancelOff", "cancelOn", "starHalf", "starOff", "starOn"], b = 0; b < a.length; b++)
                this.opt[a[b]] = this.opt[a[b]].replace(".", "-")
        }, _apply: function(a) {
            c._fill.call(this, a);
            if (a) {
                a > 0 && this.score.val(c._between(a, 0, this.opt.number));
                c._roundStars.call(this, a)
            }
        }, _between: function(a, b, d) {
            return Math.min(Math.max(parseFloat(a), b), d)
        }, _binds: function() {
            if (this.cancel) {
            ...
            a.stars.on("click.raty", function(b) {
                var d = e(this);
                a.score.val(a.opt.half || a.opt.precision ? a.self.data("score") : this.alt || d.data("alt"));
                a.opt.click && a.opt.click.call(a, +a.score.val(), b)
            })
            ...
            a.cancel.on("mouseleave.raty", function(b) {
                ...
                if (a.opt.starType !== "img")
                    d = a.opt.cancelClass + " " + d;
                c._setIcon.call(a, this, d);
                if (a.opt.mouseout) {
                    d = +a.score.val() || undefined;
                    a.opt.mouseout.call(a, d, b)
                }
            })
        }, _bindOver: function() {
            var a = this;
            a.stars.on(a.opt.half ? "mousemove.raty" : "mouseover.raty",
                    function(b) {
                        var d = c._getScoreByPosition.call(a, b, this);
                        c._fill.call(a, d);
                        if (a.opt.half) {
                            c._roundStars.call(a, d);
                            a.self.data("score", d)
                        }
                        c._target.call(a, d, b);
            ...
            a.cancel.on("mouseover.raty", function(b) {
                var d = a.opt.path + a.opt.starOff, f = a.opt.cancelOn;
                if (a.opt.starType === "img")
                    a.stars.attr("src", d);
                else {
                    f = a.opt.cancelClass + " " + f;
                    a.stars.attr("class", d)
                }
                c._setIcon.call(a, this, f);
            ...
            var a = this.opt.path + this.opt.cancelOff, b = e("<" + this.opt.starType + " />", {title: this.opt.cancelHint, "class": this.opt.cancelClass});
            this.opt.starType === "img" ? b.attr({src: a, alt: "x"}) : b.attr("data-alt", "x").addClass(a);
            this.opt.cancelPlace === "left" ? this.self.prepend(" ").prepend(b) : this.self.append(" ").append(b);
            this.cancel = b
            ...
            for (var a = 1; a <= this.opt.number; a++) {
                var b = c._nameForIndex.call(this, a);
                b = {alt: a, src: this.opt.path + this.opt[b]};
                if (this.opt.starType !== "img")
                    b = {"data-alt": a, "class": b.src};
                b.title = c._getHint.call(this, a);
                e("<" + this.opt.starType + " />", b).appendTo(this);
                if (this.opt.space)
                    this.self.append(a < this.opt.number ? " " : "")
            }
            ...
            for (var b = 0, d = 1; d <= this.stars.length; d++) {
                var f, g = this.stars[d - 1];
                f = c._turnOn.call(this, d, a);
                if (this.opt.iconRange && this.opt.iconRange.length > b) {
                    var h = this.opt.iconRange[b];
                    f = c._getRangeIcon.call(this, h, f);
                    d <= h.range && c._setIcon.call(this, g, f);
                    d === h.range && b++
                } else {
                    f = this.opt[f ? "starOn" : "starOff"];
                    c._setIcon.call(this, g, f)
                }
            }
        }, _getRangeIcon: function(a, b) {
            return b ? a.on || this.opt.starOn : a.off || this.opt.starOff
        }, _getScoreByPosition: function(a, b) {
            var d = parseInt(b.alt || b.getAttribute("data-alt"),
                    10);
            if (this.opt.half) {
                var f = c._getSize.call(this);
                f = parseFloat((a.pageX - e(b).offset().left) / f);
                d = this.opt.precision ? d - 1 + f : d - 1 + (f > 0.5 ? 1 : 0.5)
            }
            return d
        }, _getSize: function() {
            var a;
            (a = this.opt.starType === "img" ? this.stars[0].width : parseFloat(this.stars.eq(0).css("font-size"))) || c._error.call(this, "Could not be possible get the icon size!");
            return a
            ...
            var a = parseInt(this.score.val(),
                    10);
            a = a ? c._getHint.call(this, a) : this.opt.noRatedMsg;
            this.style.cursor = "";
            this.title = a;
            ...
            if (b > this.opt.round.down) {
                ...
                if (this.opt.halfShow && b < this.opt.round.up)
                    d = "starHalf";
                else if (b < this.opt.round.full)
                    d = "starOff";
                c._setIcon.call(this,
                        this.stars[Math.ceil(a) - 1], this.opt[d])
            }
            ...
            if (this.opt.target) {
                ...
                if (a === undefined)
                    ...
                    if (this.opt.targetType === "hint")
                        a = c._getHint.call(this, Math.ceil(a));
                    else if (this.opt.precision)
                        a = parseFloat(a).toFixed(1);
                    var g = b && b.type === "mousemove";
                    if (!f && !g && !this.opt.targetKeep)
                        a = this.opt.targetText
                }
                c._setTarget.call(this, d, a)
            }
        }, _unlock: function() {
            this.style.cursor = "pointer";
            ...
            return this.each(function() {
                ...
                if (b.data("readonly") !== true) {
                    c[a ? "click" : "score"].call(b, null);
                    this.score.removeAttr("value")
                }
            })
        }, click: function(a) {
            return this.each(function() {
                if (e(this).data("readonly") !== true) {
                    c._apply.call(this, a);
                    this.opt.click && this.opt.click.call(this, a, e.Event("click"));
                    c._target.call(this, a)
                }
            })
        }, destroy: function() {
            return this.each(function() {
                var a = e(this), b = a.data("raw");
                b ? a.off(".raty").empty().css({cursor: b.style.cursor}).removeData("readonly") :
            ...
            this.each(function() {
                b = this.score.val();
                a.push(b ? +b : undefined)
            });
            return a.length > 1 ? a : a[0]
        }, move: function(a) {
            return this.each(function() {
                var b = parseInt(a, 10), d = e(this).data("options"), f = (+a).toFixed(1).split(".")[1];
                if (b >= d.number) {
                    b = d.number - 1;
                    f = 10
                }
                d = c._getSize.call(this) / 10;
                b = e(this.stars[b]);
                f = b.offset().left + d * parseInt(f, 10);
                f = e.Event("mousemove", {pageX: f});
                b.trigger(f)
            })
        }, readOnly: function(a) {
            return this.each(function() {
            ...
            return this.each(function() {
                var b = e(this), d = b.data("options");
                d = e.extend({}, d, a);
                b.raty(d)
            })
        }, setScore: function(a) {
            return this.each(function() {
                if (e(this).data("readonly") !==
                        true) {
                    c._apply.call(this, a);
                    c._target.call(this, a)
                }
    ...
    e.fn.raty = function(a) {
        if (c[a])
            return c[a].apply(this, Array.prototype.slice.call(arguments, 1));
        else if (typeof a === "object" || !a)
            return c.init.apply(this, arguments);
        else
            e.error("Method " + a + " does not exist!")
    };
    e.fn.raty.defaults = {cancel: false, cancelClass: "raty-cancel", cancelHint: "Cancel this rating!", cancelOff: "cancel-off.png", cancelOn: "cancel-on.png", cancelPlace: "left", click: undefined, half: false, halfShow: true, hints: ["bad", "poor", "regular", "good",
...
(function(h) {
    if (typeof define === "function" && define.amd)
        ...
        typeof exports === "object" ? h(require("jquery")) : h(jQuery)
})(function(h) {
    var z = h(window), A = h(document), v = window.location, K = /^(e|n|w|s|ne|nw|sw|se|all|crop|move|zoom)$/, L = /^(x|y|width|height)$/, M = /^(naturalWidth|naturalHeight|width|height|aspectRatio|ratio|rotate)$/, u = function(a) {
        return typeof a === "number"
    }, w = function(a, b) {
        var c = [];
        typeof b === "number" && c.push(b);
        return c.slice.apply(a, c)
    }, x = function(a, b) {
        var c = w(arguments,
                2);
        return function() {
            return a.apply(b, c.concat(w(arguments)))
        }
    }, n = function(a, b) {
        this.element = a;
        this.$element = h(a);
        this.defaults = h.extend({}, n.DEFAULTS, h.isPlainObject(b) ? b : {});
        this.$original = null;
        this.replaced = this.disabled = this.rotated = this.cropped = this.built = this.ready = false;
        this.init()
    }, y = Math.sqrt, p = Math.min, q = Math.max, o = Math.abs, B = Math.sin, C = Math.cos, s = parseFloat;
    n.prototype = {constructor: n, support: {canvas: h.isFunction(h("<canvas>")[0].getContext)}, init: function() {
            var a = this.defaults;
            h.each(a,
                    function(b, c) {
                        switch (b) {
            ...
            var a = this, b = this.$element, c = this.element, e = this.image, d = "", g, i;
            if (b.is("img"))
                i = b.prop("src");
            else if (b.is("canvas") && this.support.canvas)
                i = c.toDataURL();
            if (i) {
                if (this.replaced)
                    e.rotate = 0;
                if (this.defaults.checkImageOrigin)
                    if (b.prop("crossOrigin") ||
                            this.isCrossOriginURL(i))
                        d = " crossOrigin";
                this.$clone = g = h("<img" + d + ' src="' + i + '">');
                g.one("load", function() {
                    e.naturalWidth = this.naturalWidth || g.width();
                    e.naturalHeight = this.naturalHeight || g.height();
                    e.aspectRatio = e.naturalWidth / e.naturalHeight;
                    a.url = i;
                    a.ready = true;
                    a.build()
                });
                g.addClass("cropper-invisible").prependTo("body")
            }
        }, isCrossOriginURL: function(a) {
            if ((a = a.match(/^(https?:)\/\/([^\:\/\?#]+):?(\d*)/i)) && (a[1] !== v.protocol || a[2] !== v.hostname || a[3] !== v.port))
                return true;
            return false
        }, build: function() {
            var a =
                    this.$element, b = this.defaults, c;
            if (this.ready) {
                this.built && this.unbuild();
                a.one("build.cropper", b.build);
                c = h.Event("build.cropper");
                a.trigger(c);
                if (!c.isDefaultPrevented()) {
                    this.$cropper = c = h(n.TEMPLATE);
                    a.addClass("cropper-hidden");
                    this.$clone.removeClass("cropper-invisible").prependTo(c);
                    if (!this.rotated) {
                        this.$original = this.$clone.clone();
                        this.$original.addClass("cropper-hidden").prependTo(this.$cropper);
                        this.originalImage = h.extend({}, this.image)
                    }
                    this.$container = a.parent();
                    this.$container.append(c);
                    this.$canvas = c.find(".cropper-canvas");
                    this.$dragger = c.find(".cropper-dragger");
                    this.$viewer = c.find(".cropper-viewer");
                    b.autoCrop ? this.cropped = true : this.$dragger.addClass("cropper-hidden");
                    b.dragCrop && this.setDragMode("crop");
                    b.modal && this.$canvas.addClass("cropper-modal");
                    !b.dashed && this.$dragger.find(".cropper-dashed").addClass("cropper-hidden");
                    !b.movable && this.$dragger.find(".cropper-face").data("directive", "move");
                    !b.resizable && this.$dragger.find(".cropper-line, .cropper-point").addClass("cropper-hidden");
                    this.addListeners();
                    this.initPreview();
                    this.built = true;
                    this.update();
                    this.replaced = false;
                    a.one("built.cropper", b.built);
                    a.trigger("built.cropper")
                }
            }
        }, unbuild: function() {
            if (this.built) {
                ...
                this.$preview.empty();
                this.$container = this.$canvas = this.$dragger = this.$preview = null;
                this.$cropper.remove();
                this.$cropper = null
            }
        }, update: function(a) {
        ...
        resize: function() {
            ...
            this.resizing = setTimeout(h.proxy(this.update, this, this.getData()), 200)
        }, preview: function() {
            var a = this.image, b = this.dragger, c = a.width, e = a.height, d = b.left - a.left, g = b.top - a.top;
            this.$viewer.find("img").css({width: c, height: e, marginLeft: -d, marginTop: -g});
            this.$preview.each(function() {
                var i = h(this), j = i.width() / b.width;
                i.find("img").css({width: c * j, height: e * j, marginLeft: -d * j, marginTop: -g * j})
            })
        }, addListeners: function() {
            var a = this.defaults;
            this.$element.on("dragstart.cropper",
                    a.dragstart).on("dragmove.cropper", a.dragmove).on("dragend.cropper", a.dragend);
            this.$cropper.on("mousedown touchstart", h.proxy(this.dragstart, this)).on("dblclick", h.proxy(this.dblclick, this));
            if (a.zoomable)
                this.$cropper.on("wheel mousewheel DOMMouseScroll", h.proxy(this.wheel, this));
            if (a.multiple)
                this.$cropper.on("mousemove touchmove", h.proxy(this.dragmove, this)).on("mouseup mouseleave touchend touchleave touchcancel", h.proxy(this.dragend, this));
            else
                A.on("mousemove touchmove", this._dragmove = x(this.dragmove,
                        this)).on("mouseup mouseleave touchend touchleave touchcancel", this._dragend = x(this.dragend, this));
            z.on("resize.cropper", this._resize = x(this.resize, this))
        }, removeListeners: function() {
            var a = this.defaults;
            this.$element.off("dragstart.cropper", a.dragstart).off("dragmove.cropper", a.dragmove).off("dragend.cropper", a.dragend);
            this.$cropper.off("mousedown touchstart", this.dragstart).off("dblclick", this.dblclick);
            a.zoomable && this.$cropper.off("wheel mousewheel DOMMouseScroll", this.wheel);
            a.multiple ? this.$cropper.off("mousemove touchmove",
                    this.dragmove).off("mouseup mouseleave touchend touchleave touchcancel", this.dragend) : A.off("mousemove touchmove", this._dragmove).off("mouseup mouseleave touchend touchleave touchcancel", this._dragend);
            z.off("resize.cropper", this._resize)
        }, initPreview: function() {
            var a = '<img src="' + this.url + '">';
            this.$preview = h(this.defaults.preview);
            this.$viewer.html(a);
            this.$preview.html(a).find("img").css("cssText", "min-width:0!important;min-height:0!important;max-width:none!important;max-height:none!important;")
        },
        initContainer: function() {
            var a = this.$container;
            this.container = {width: q(a.width(), 300), height: q(a.height(), 150)}
        }, initCropper: function() {
            var a = this.container, b = this.image;
            if (b.naturalWidth * a.height / b.naturalHeight - a.width >= 0) {
                b = {width: a.width, height: a.width / b.aspectRatio, left: 0};
                b.top = (a.height - b.height) / 2
            } else {
                b = {width: a.height * b.aspectRatio, height: a.height, top: 0};
                b.left = (a.width - b.width) / 2
            }
            this.$cropper.css({width: b.width, height: b.height, left: b.left, top: b.top});
            this.cropper = b
        }, initImage: function() {
            var a =
                    this.image, b = this.cropper, c = {_width: b.width, _height: b.height, width: b.width, height: b.height, left: 0, top: 0, ratio: b.width / a.naturalWidth};
            this.defaultImage = h.extend({}, a, c);
            if (a._width !== b.width || a._height !== b.height)
                h.extend(a, c);
            else {
                a = h.extend({}, c, a);
                if (this.replaced)
            ...
            b.left = p(q(b.left, b._width - b.width), 0);
            b.top = p(q(b.top, b._height -
                    b.height), 0);
            this.$clone.css({width: b.width, height: b.height, marginLeft: b.left, marginTop: b.top});
            if (a) {
                this.defaults.done(this.getData());
                this.preview()
            }
        }, initDragger: function() {
            var a = this.defaults, b = this.cropper, c = a.aspectRatio || this.image.aspectRatio, e = this.image.ratio, d;
            d = b.height * c - b.width >= 0 ? {height: b.width / c, width: b.width, left: 0, top: (b.height - b.width / c) / 2, maxWidth: b.width, maxHeight: b.width / c} : {height: b.height, width: b.height * c, left: (b.width - b.height * c) / 2, top: 0, maxWidth: b.height * c, maxHeight: b.height};
            d.minWidth = 0;
            d.minHeight = 0;
            if (a.aspectRatio) {
                if (isFinite(a.maxWidth)) {
                    d.maxWidth = p(d.maxWidth, a.maxWidth * e);
                    d.maxHeight = d.maxWidth / c
                } else if (isFinite(a.maxHeight)) {
                    d.maxHeight = p(d.maxHeight, a.maxHeight * e);
                    d.maxWidth = d.maxHeight * c
                }
                if (a.minWidth > 0) {
                    d.minWidth = q(0, a.minWidth * e);
                    d.minHeight = d.minWidth / c
                } else if (a.minHeight > 0) {
                    d.minHeight = q(0, a.minHeight * e);
                    d.minWidth = d.minHeight * c
                }
            } else {
                d.maxWidth = p(d.maxWidth, a.maxWidth * e);
                d.maxHeight = p(d.maxHeight, a.maxHeight * e);
            ...
            d.minWidth = p(d.maxWidth, d.minWidth);
            d.minHeight = p(d.maxHeight, d.minHeight);
            d.height *= a.autoCropArea;
            d.width *= a.autoCropArea;
            d.left = (b.width - d.width) / 2;
            d.top = (b.height - d.height) / 2;
            d.oldLeft = d.left;
            d.oldTop = d.top;
            this.defaultDragger = d;
            this.dragger = h.extend({}, d)
        }, renderDragger: function() {
            var a = this.dragger, b = this.cropper;
            if (a.width > a.maxWidth) {
                a.width = a.maxWidth;
                a.left = a.oldLeft
            } else if (a.width < a.minWidth) {
                a.width = a.minWidth;
                a.left = a.oldLeft
            }
            if (a.height > a.maxHeight) {
                ...
                a.top = a.oldTop
            } else if (a.height < a.minHeight) {
                a.height = a.minHeight;
                a.top = a.oldTop
            }
            a.left = p(q(a.left, 0), b.width - a.width);
            a.top = p(q(a.top, 0), b.height - a.height);
            a.oldLeft = a.left;
            a.oldTop = a.top;
            this.dragger = a;
            this.disabled || this.defaults.done(this.getData());
            this.$dragger.css({width: a.width, height: a.height, left: a.left, top: a.top});
            this.preview()
        }, reset: function(a) {
            if (this.cropped) {
                if (a)
                    this.defaults.data = {};
                this.image = h.extend({}, this.defaultImage);
                this.renderImage();
                this.dragger = h.extend({}, this.defaultDragger);
                this.setData(this.defaults.data)
            }
        }, clear: function() {
            if (this.cropped) {
                ...
                this.$canvas.removeClass("cropper-modal");
                this.$dragger.addClass("cropper-hidden")
            }
        }, destroy: function() {
            var a = this.$element;
            if (this.ready) {
                this.unbuild();
                a.removeClass("cropper-hidden").removeData("cropper");
                this.rotated && a.attr("src", this.$original.attr("src"))
            }
        }, replace: function(a, b) {
            var c = this, e = this.$element, d = this.element, g;
            if (a && a !== this.url && a !== e.attr("src")) {
                if (!b) {
                    this.rotated =
                            false;
                    this.replaced = true
                ...
                if (e.is("img")) {
                    e.attr("src", a);
                    this.load()
                } else if (e.is("canvas") && this.support.canvas) {
                    g = d.getContext("2d");
                    h('<img src="' + a + '">').one("load", function() {
                        d.width = this.width;
            ...
            var c = this.cropper, e = this.dragger, d = this.image, g = this.defaults.aspectRatio;
            if (!(!this.built || typeof a === "undefined")) {
                if (a === null || h.isEmptyObject(a))
                    e = h.extend({}, this.defaultDragger);
                if (h.isPlainObject(a) &&
                        !h.isEmptyObject(a)) {
                    if (!b)
                        this.defaults.data = a;
                    a = this.transformData(a);
                    if (u(a.x) && a.x <= c.width - d.left)
                        e.left = a.x + d.left;
                    if (u(a.y) && a.y <= c.height - d.top)
                        e.top = a.y + d.top;
                    if (g)
                        if (u(a.width) && a.width <= e.maxWidth && a.width >= e.minWidth) {
                            e.width = a.width;
                            e.height = e.width / g
                        } else {
                            if (u(a.height) && a.height <= e.maxHeight && a.height >= e.minHeight) {
                                e.height = a.height;
                                e.width = e.height * g
                            }
                        }
            ...
            var b = this.dragger, c = this.image, e = {};
            if (this.built) {
                e = {x: b.left - c.left, y: b.top - c.top, width: b.width, height: b.height};
                e = this.transformData(e, true, a)
            }
            return e
        }, transformData: function(a, b, c) {
            var e = this.image.ratio, d = {};
            h.each(a, function(g, i) {
                i = s(i);
                if (L.test(g) && !isNaN(i))
                    d[g] = b ? c ? Math.round(i / e) : i / e : i * e
            });
            return d
            ...
            a = s(a);
            if (b || !isNaN(a) && a > 0) {
                this.defaults.aspectRatio = b ? NaN : a;
                if (this.built) {
                    this.initDragger();
                    this.renderDragger()
                }
            ...
            var a = {};
            this.ready && h.each(this.image, function(b, c) {
                if (M.test(b))
                    a[b] = c
            });
            return a
        }, getDataURL: function(a, b, c) {
            var e = h("<canvas>")[0], d = this.getData(), g = "";
            if (!h.isPlainObject(a)) {
                c = b;
                b = a;
                a = {}
            }
            a = h.extend({width: d.width, height: d.height}, a);
            if (this.cropped && this.support.canvas) {
                ...
                g.drawImage(this.$clone[0], d.x, d.y, d.width, d.height,
                        0, 0, a.width, a.height);
                g = e.toDataURL(b, c)
            }
            return g
        }, setDragMode: function(a) {
            var b = this.$canvas, c = this.defaults, e = false, d = false;
            if (!(!this.built || this.disabled)) {
                switch (a) {
                    ...
                    case "move":
                        ...
                        break;
                    default:
                        b.removeData("directive")
                }
                b.toggleClass("cropper-crop", e).toggleClass("cropper-move", d)
            }
        }, enable: function() {
            if (this.built) {
                this.disabled = false;
            ...
            var b = this.image;
            a = s(a) || 0;
            if (!(!this.built || a === 0 || this.disabled || !this.defaults.rotatable || !this.support.canvas)) {
                this.rotated = true;
                a = b.rotate = (b.rotate + a) % 360;
                this.replace(this.getRotatedDataURL(a), true)
            }
        }, getRotatedDataURL: function(a) {
            var b = h("<canvas>")[0], c = b.getContext("2d"), e = a * Math.PI / 180;
            a = o(a) % 180;
            var d = (a > 90 ? 180 - a : a) * Math.PI / 180, g = this.originalImage;
            a = g.naturalWidth;
            g = g.naturalHeight;
            var i = o(a * C(d) + g * B(d));
            d = o(a * B(d) +
            ...
            c.translate(i / 2, d / 2);
            c.rotate(e);
            c.drawImage(this.$original[0], -a / 2, -g / 2, a, g);
            c.restore();
            return b.toDataURL()
        }, zoom: function(a) {
            var b = this.image, c, e;
            a = s(a);
            if (!(!this.built || !a || this.disabled || !this.defaults.zoomable)) {
                c = b.width * (1 + a);
                a = b.height * (1 + a);
                e = c / b._width;
                if (!(e > 10)) {
        ...
        dblclick: function() {
            this.disabled || (this.$canvas.hasClass("cropper-crop") ? this.setDragMode("move") : this.setDragMode("crop"))
        }, wheel: function(a) {
            ...
            if (!this.disabled) {
                ...
                if (b.deltaY) {
                    a = b.deltaY;
                    a = a % 5 === 0 ? a / 5 : a % 117.25 === 0 ? a / 117.25 : a / 166.66665649414062
                } else
                    a = b.wheelDelta ? -b.wheelDelta / 120 : b.detail ? b.detail / 3 : 0;
                this.zoom(a * 0.1)
            }
        }, dragstart: function(a) {
            var b = a.originalEvent.touches, c = a, e;
            if (!this.disabled) {
                if (b) {
                    c = b.length;
                    if (c > 1)
                        if (this.defaults.zoomable && c === 2) {
                            c =
                                    b[1];
                            this.startX2 = c.pageX;
                            this.startY2 = c.pageY;
                            e = "zoom"
                        } else
                            return;
                    c = b[0]
                }
                e = e || h(c.target).data("directive");
                if (K.test(e)) {
                    a.preventDefault();
                    a = h.Event("dragstart.cropper");
                    ...
                    if (!a.isDefaultPrevented()) {
                        ...
                        if (e === "crop") {
                            this.cropping = true;
                            this.$canvas.addClass("cropper-modal")
                        }
                    }
                }
            }
        }, dragmove: function(a) {
            var b = a.originalEvent.touches, c = a;
            if (!this.disabled) {
                if (b) {
                    c = b.length;
                    if (c > 1)
                        if (this.defaults.zoomable &&
                                c === 2) {
                            c = b[1];
                            this.endX2 = c.pageX;
                            this.endY2 = c.pageY
            ...
            if (!this.disabled)
                if (this.directive) {
                    a.preventDefault();
                    a = h.Event("dragend.cropper");
                    this.$element.trigger(a);
                    if (!a.isDefaultPrevented()) {
                        if (this.cropping) {
                            this.cropping = false;
                            this.$canvas.toggleClass("cropper-modal", this.cropped && this.defaults.modal)
                        }
                        this.directive =
                                ""
                    }
            ...
            var a = this.directive, b = this.image, c = this.cropper, e = c.width, d = c.height;
            c = this.dragger;
            var g = c.width, i = c.height, j = c.left, k = c.top, t = j + g, r = k + i, m = true, D = this.defaults, l = D.aspectRatio, f = {x: this.endX - this.startX, y: this.endY - this.startY};
            if (l) {
                f.X = f.y * l;
                f.Y = f.x / l
            }
            switch (a) {
                ...
                case "zoom":
                    if (D.zoomable) {
                        this.zoom(function(E, F, G, H, I, J) {
                            return(y(I * I + J * J) - y(G * G + H * H)) / y(E * E + F * F)
                        }(b.width, b.height, o(this.startX - this.startX2), o(this.startY - this.startY2), o(this.endX - this.endX2), o(this.endY - this.endY2)));
                ...
                case "crop":
                    if (f.x && f.y) {
                        ...
                        if (!this.cropped) {
                            this.cropped = true;
                            this.$dragger.removeClass("cropper-hidden")
                        }
                    }
            }
            if (m) {
    ...
    n.DEFAULTS = {aspectRatio: "auto", autoCropArea: 0.8, data: {}, done: h.noop, preview: "", multiple: false, autoCrop: true, dragCrop: true, dashed: true, modal: true, movable: true, resizable: true, zoomable: true, rotatable: true, checkImageOrigin: true, minWidth: 0, minHeight: 0, maxWidth: Infinity, maxHeight: Infinity, build: null, built: null, dragstart: null, dragmove: null, dragend: null};
    n.setDefaults = function(a) {
        h.extend(n.DEFAULTS, a)
    };
    n.other = h.fn.cropper;
    h.fn.cropper = function(a) {
        var b =
                w(arguments, 1), c;
        this.each(function() {
            var e = h(this), d = e.data("cropper"), g;
            d || e.data("cropper", d = new n(this, a));
            if (typeof a === "string" && h.isFunction(g = d[a]))
                c = g.apply(d, b)
        });
        return typeof c !== "undefined" ? c : this
    };
    h.fn.cropper.Constructor = n;
    h.fn.cropper.setDefaults = n.setDefaults;
    h.fn.cropper.noConflict = function() {
        h.fn.cropper = n.other;
        return this
    }
});
...
(function(b) {
    ...
    j.prototype = {show: function() {
            ...
            if (a && this.enabled) {
                ...
                a = b.extend({}, this.$element.offset(), {width: this.$element[0].offsetWidth, height: this.$element[0].offsetHeight});
                var d = c[0].offsetWidth, h = c[0].offsetHeight,
                        f = typeof this.options.gravity == "function" ? this.options.gravity.call(this.$element[0]) : this.options.gravity, g;
                switch (f.charAt(0)) {
                    case "n":
                        g = {top: a.top + a.height + this.options.offset, left: a.left + a.width / 2 - d / 2};
                        break;
                    case "s":
                        g = {top: a.top - h - this.options.offset, left: a.left + a.width / 2 - d / 2};
                        break;
                    case "e":
                        g = {top: a.top + a.height / 2 - h / 2, left: a.left - d - this.options.offset};
                        break;
                    case "w":
                        extra_gap = 0;
                        if (b("body").css("position").length > 0 && b("body").css("position") == "relative")
                            if (b("#wpadminbar").length)
                                extra_gap =
                                        b("#wpadminbar").height();
                        g = {top: a.top + a.height / 2 - h / 2 - extra_gap, left: a.left + a.width + this.options.offset}
                }
                if (f.length == 2)
                    g.left = f.charAt(1) == "w" ? a.left + a.width / 2 - 15 : a.left + a.width / 2 - d + 15;
                c.css(g).addClass("tipsy-" + f);
                c.find(".tipsy-arrow")[0].className = "tipsy-arrow tipsy-arrow-" + f.charAt(0);
                this.options.className && c.addClass(typeof this.options.className == "function" ? this.options.className.call(this.$element[0]) : this.options.className);
                this.options.fade ? c.stop().css({opacity: 0, display: "block", visibility: "visible"}).animate({opacity: this.options.opacity}) :
                        c.css({visibility: "visible", opacity: this.options.opacity})
            }
        }, hide: function() {
            ...
            if (typeof d.title == "string")
                a = c.attr(d.title == "title" ? "original-title" : d.title);
            else if (typeof d.title == "function")
                a = d.title.call(c[0]);
            return("" + a).replace(/(^\s*|\s*$)/, "") || d.fallback
        }, tip: function() {
            if (!this.$tip) {
    ...
    b.fn.tipsy = function(a) {
        function c(e) {
            var i = b.data(e, "tipsy");
            if (!i) {
                i = new j(e, b.fn.tipsy.elementOptions(e, a));
                b.data(e, "tipsy", i)
            }
            return i
        }
        ...
        function h() {
            var e = c(this);
            e.hoverState = "out";
            a.delayOut == 0 ? e.hide() : setTimeout(function() {
        ...
        if (a.trigger != "manual") {
            var g = a.trigger == "hover" ? "mouseleave" : "blur";
            this['on'](a.trigger == "hover" ? "mouseenter" : "focus", d)['on'](g, h)
        }
        return this
    };
    b.fn.tipsy.defaults = {className: null, delayIn: 0, delayOut: 0, fade: false, fallback: "", gravity: "n", html: false, live: false, offset: 0, opacity: 0.8, title: "title", trigger: "hover"};
    b.fn.tipsy.revalidate = function() {
        b(".tipsy").each(function() {
            var a =
                    b.data(this, "tipsy-pointee"), c;
            if (!(c = !a)) {
                a:{
                    for (; a = a.parentNode; )
                        if (a == document) {
    ...
    b.fn.tipsy.autoBounds = function(a, c) {
        return function() {
            var d =
                    {ns: c[0], ew: c.length > 1 ? c[1] : false}, h = b(document).scrollTop() + a, f = b(document).scrollLeft() + a, g = b(this);
            if (g.offset().top < h)
                d.ns = "n";
            if (g.offset().left < f)
                d.ew = "w";
            if (b(window).width() + b(document).scrollLeft() - g.offset().left < a)
                d.ew = "e";
            if (b(window).height() + b(document).scrollTop() - g.offset().top < a)
                d.ns = "s";
...
function UM_domenus() {
    jQuery('.um-dropdown').each(function() {
        ...
        if (position == 'lc') {
            ...
            menu.css({'top': 0, 'width': 200, 'left': 'auto', 'right': gap_right + 'px', 'text-align': 'center'});
            menu.find('.um-dropdown-arr').find('i').removeClass().addClass('um-icon-arrow-right-b');
            menu.find('.um-dropdown-arr').css({'top': '4px', 'left': 'auto', 'right': '-17px'})
        }
        if (position == 'bc') {
            if (200 > jQuery(element).find('img').width()) {
                left_p = ((jQuery(element).width() - jQuery(element).find('img').width()) / 2) + ((jQuery(element).find('img').width() - 200) / 2)
            ...
            menu.css({'top': top_p, 'width': 200, 'left': left_p + left_gap, 'right': 'auto', 'text-align': 'center'});
            menu.find('.um-dropdown-arr').find('i').removeClass().addClass('um-icon-arrow-up-b');
            menu.find('.um-dropdown-arr').css({'top': '-17px', 'left': (menu.width() / 2) - 12, 'right': 'auto'})
        }
    })
}
...
function UM_Member_Grid(container) {
    container.masonry({itemSelector: '.um-member', columnWidth: '.um-member', gutter: '.um-gutter-sizer'})
}
...
function initFileUpload_UM(trigger) {
    ...
    trigger.uploadFile({url: um_scripts.fileupload, method: "POST", multiple: false, formData: {key: trigger.data('key'), set_id: trigger.data('set_id'), set_mode: trigger.data('set_mode')}, fileName: trigger.data('key'), allowedTypes: trigger.data('allowed_types'), maxFileSize: trigger.data('max_size'), dragDropStr: icon + upload_text + upload_help_text, sizeErrorStr: trigger.data('max_size_error'), extErrorStr: trigger.data('extension_error'), maxFileCountErrorStr: trigger.data('max_files_error'), maxFileCount: 1, showDelete: false, showAbort: false, showDone: false, showFileCounter: false, showStatusAfterSuccess: true, onSubmit: function(files) {
            trigger.parents('.um-modal-body').find('.um-error-block').remove()
        }, onSuccess: function(files, data, xhr) {
            trigger.selectedFiles = 0;
            data = jQuery.parseJSON(data);
...
function initCrop_UM() {
    ...
    if (target_img.length) {
        if (target_img.attr('src') != '') {
            ...
            if (crop_data == 'square') {
                var opts = {minWidth: min_width, minHeight: min_height, dragCrop: false, aspectRatio: 1.0, zoomable: false, rotatable: false, dashed: false, done: function(data) {
                ...
                var opts = {minWidth: min_width, minHeight: Math.round(min_width / ratio), dragCrop: false, aspectRatio: ratio, zoomable: false, rotatable: false, dashed: false, done: function(data) {
                        target_img.parent().attr('data-coord', Math.round(data.x) + ',' + Math.round(data.y) + ',' + Math.round(data.width) + ',' + Math.round(data.height))
                    }}
            } else if (crop_data == 'user') {
                var opts = {minWidth: min_width, minHeight: min_height, dragCrop: true, aspectRatio: "auto", zoomable: false, rotatable: false, dashed: false, done: function(data) {
                        target_img.parent().attr('data-coord', Math.round(data.x) + ',' + Math.round(data.y) + ',' + Math.round(data.width) + ',' + Math.round(data.height))
                    }}
            }
            if (crop_data != 0) {
...
function um_new_modal(id, size, isPhoto, source) {
    ...
    if (modal.length == 0) {
        ...
        if (isPhoto) {
            ...
            var photo_maxh = jQuery(window).height() - (jQuery(window).height() * .25);
            ...
            photo_.load(function() {
                ...
                jQuery('.um-modal').css({'width': photo_.width(), 'margin-left': '-' + photo_.width() / 2 + 'px'});
...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("click", 'a[data-modal^="um_"], span[data-modal^="um_"], .um-modal a', function(a) {
        a.preventDefault();
        return false
    });
    jQuery(document).on("click", ".um-modal .um-single-file-preview a.cancel", function(a) {
        a.preventDefault();
        a = jQuery(this).parents(".um-modal-body");
        var b = jQuery(this).parents(".um-modal-body").find(".um-single-fileinfo a").attr("href");
        a.find(".um-single-file-preview").hide();
        a.find(".ajax-upload-dragdrop").show();
        a.find(".um-modal-btn.um-finish-upload").addClass("disabled");
        um_modal_responsive();
        jQuery.ajax({url: um_scripts.ajaxurl, type: "post", data: {action: "ultimatemember_remove_file", src: b}});
        return false
    });
    jQuery(document).on("click", ".um-modal .um-single-image-preview a.cancel", function(a) {
        a.preventDefault();
        a = jQuery(this).parents(".um-modal-body");
        var b = jQuery(this).parents(".um-modal-body").find(".um-single-image-preview img").attr("src");
        jQuery('img.cropper-hidden').cropper('destroy');
    ...
    jQuery(document).on("click", ".um-finish-upload.file", function() {
        ...
        um_remove_modal();
        jQuery(".um-single-file-preview[data-key=" + a + "]").fadeIn().html(b);
        jQuery(".um-single-file-preview[data-key=" + a + "]").parents(".um-field").find(".um-btn-auto-width").html(jQuery(this).attr("data-change"));
        jQuery(".um-single-file-preview[data-key=" + a + "]").parents(".um-field").find("input[type=hidden]").val(jQuery(".um-single-file-preview[data-key=" + a + "]").parents(".um-field").find(".um-single-fileinfo a").attr("href"))
    });
    jQuery(document).on("click", ".um-finish-upload.image", function() {
        var a = jQuery(this), b = jQuery(this).attr("data-key"), c = jQuery(this).parents(".um-modal-body").find(".um-single-image-preview"), f = c.find("img").attr("src");
        c = c.attr("data-coord");
        var g = jQuery(this).parents("#um_upload_single").attr("data-user_id") ? jQuery(this).parents("#um_upload_single").attr("data-user_id") : 0;
        if (c) {
            jQuery(this).html(jQuery(this).attr("data-processing")).addClass("disabled");
            jQuery.ajax({url: um_scripts.ajaxurl, type: "POST",
                data: {action: "ultimatemember_resize_image", src: f, coord: c, user_id: g, key: b}, success: function(e) {
                    d = new Date;
                    b == "profile_photo" && jQuery(".um-profile-photo-img img").attr("src", e + "?" + d.getTime());
                    if (b == "cover_photo") {
                        jQuery(".um-cover-e").empty().html('<img src="' + e + "?" + d.getTime() + '" alt="" />');
                        jQuery(".um").hasClass("um-editing") && jQuery(".um-cover-overlay").show()
                    }
                    jQuery(".um-single-image-preview[data-key=" + b + "]").fadeIn().find("img").attr("src", e + "?" + d.getTime());
                    um_remove_modal();
                    jQuery(".um-single-image-preview[data-key=" +
                            b + "]").parents(".um-field").find(".um-btn-auto-width").html(a.attr("data-change"));
                    jQuery(".um-single-image-preview[data-key=" + b + "]").parents(".um-field").find("input[type=hidden]").val(e)
                }})
        } else {
            d = new Date;
            jQuery(".um-single-image-preview[data-key=" + b + "]").fadeIn().find("img").attr("src", f + "?" + d.getTime());
            um_remove_modal();
            jQuery(".um-single-image-preview[data-key=" + b + "]").parents(".um-field").find(".um-btn-auto-width").html(a.attr("data-change"));
            jQuery(".um-single-image-preview[data-key=" + b +
                    "]").parents(".um-field").find("input[type=hidden]").val(f)
        }
    });
    jQuery(document).on("click", 'a[data-modal^="um_"], span[data-modal^="um_"]', function() {
        var a = jQuery(this).attr("data-modal"), b = jQuery(this).data("modal-size") ? jQuery(this).data("modal-size") : "normal";
        if (jQuery(this).data("modal-copy")) {
            jQuery("#" + a).html(jQuery(this).parents(".um-field").find(".um-modal-hidden-content").html());
            jQuery(this).parents(".um-profile-photo").attr("data-user_id") && jQuery("#" + a).attr("data-user_id", jQuery(this).parents(".um-profile-photo").attr("data-user_id"));
            jQuery(this).parents(".um-cover").attr("data-ratio") && jQuery("#" + a).attr("data-ratio", jQuery(this).parents(".um-cover").attr("data-ratio"));
            jQuery(this).parents(".um-cover").attr("data-user_id") && jQuery("#" + a).attr("data-user_id", jQuery(this).parents(".um-cover").attr("data-user_id"))
        }
        um_new_modal(a, b)
    });
    ...
    jQuery(document).on('click', '.um-trigger-menu-on-click', function(e) {
        ...
        if (jQuery(this).find(".um-dropdown").is(":hidden")) {
    ...
    jQuery(document).on('click', ':not(.um-trigger-menu-on-click)', function(e) {
        UM_hide_menus()
    });
    ...
    jQuery('.um-datepicker').each(function() {
        ...
        var min = min.split(",");
        var max = max.split(",");
        elem.pickadate({selectYears: years_n, min: min, max: max, disable: disable, format: elem.attr('data-format'), formatSubmit: 'yyyy/mm/dd', hiddenName: true, onOpen: function() {
                elem.blur()
            }, onClose: function() {
                elem.blur()
            }})
    ...
    jQuery('.um-timepicker').each(function() {
        elem = jQuery(this);
        elem.pickatime({format: elem.attr('data-format'), interval: parseInt(elem.attr('data-intervals')), formatSubmit: 'HH:i', hiddenName: true})
    });
    jQuery('.um-rating').raty({half: false, starType: 'i', number: function() {
            return jQuery(this).attr('data-number')
        }, score: function() {
            return jQuery(this).attr('data-score')
        }, scoreName: function() {
            return jQuery(this).attr('data-key')
        }, hints: false, click: function(score, evt) {
            live_field = this.id;
            live_value = score;
            um_conditional()
        }});
    jQuery('.um-rating-readonly').raty({half: false, starType: 'i', number: function() {
            return jQuery(this).attr('data-number')
        }, score: function() {
            return jQuery(this).attr('data-score')
        }, scoreName: function() {
            return jQuery(this).attr('data-key')
        }, hints: false, readOnly: true});
    jQuery(document).on('click', '.um .um-single-image-preview a.cancel', function(e) {
        ...
        jQuery.ajax({url: um_scripts.ajaxurl, type: 'post', data: {action: 'ultimatemember_remove_file', src: src}});
        return false
    });
    ...
    jQuery(".um-s1").select2({allowClear: true, minimumResultsForSearch: 10});
    jQuery(".um-s2").select2({allowClear: false, minimumResultsForSearch: 10});
    ...
    jQuery(document).on('click', '.um-ajax-paginate', function(e) {
        ...
        jQuery.ajax({url: um_scripts.ajaxurl, type: 'post', data: {action: 'ultimatemember_ajax_paginate', hook: hook, args: args}, complete: function() {
    ...
    jQuery(document).on('click', '.um-ajax-action', function(e) {
        ...
        jQuery.ajax({url: um_scripts.ajaxurl, type: 'post', data: {action: 'ultimatemember_muted_action', hook: hook, user_id: user_id, arguments: arguments}});
        return false
    });
    jQuery('.um-members').each(function() {
        UM_Member_Grid(jQuery(this))
    ...
    jQuery(document).on('click', '.um-reset-profile-photo', function(e) {
        ...
        jQuery.ajax({url: um_scripts.ajaxurl, type: 'post', data: {action: 'ultimatemember_delete_profile_photo', metakey: metakey, user_id: user_id}})
    });
    jQuery(document).on('click', '.um-reset-cover-photo', function(e) {
        ...
        user_id = jQuery(this).attr('data-user_id');
        metakey = 'cover_photo';
        jQuery.ajax({url: um_scripts.ajaxurl, type: 'post', data: {action: 'ultimatemember_delete_cover_photo', metakey: metakey, user_id: user_id}})
    });
    var g = jQuery(".um-account-main").attr("data-current_tab");
    g && jQuery(".um-account-tab[data-tab=" + g + "]").show();
    jQuery(document).on("click", ".um-account-side li a", function(a) {
        a.preventDefault();
        a = jQuery(this);
        a.parents("ul").find("li a").removeClass("current");
        a.addClass("current");
        a = jQuery(this).attr("href");
        var b = jQuery(this).attr("data-tab");
        window.history.pushState("", "", a);
        jQuery(".um-account-tab").hide();
        jQuery(".um-account-tab[data-tab=" + b + "]").fadeIn();
        jQuery(".um-account-nav a").removeClass("current");
        jQuery(".um-account-nav a[data-tab=" + b + "]").addClass("current");
        return false
    });
    jQuery(document).on("click", ".um-account-nav a", function(a) {
        a.preventDefault();
        a = jQuery(this).attr("data-tab");
        var b = jQuery(this).parents("div"), c = jQuery(this);
        jQuery(".um-account-tab").hide();
        if (c.hasClass("current")) {
            b.next(".um-account-tab").slideUp();
            c.removeClass("current")
        } else {
            b.next(".um-account-tab").slideDown();
            c.parents("div").find("a").removeClass("current");
            c.addClass("current")
        }
        jQuery(".um-account-side li a").removeClass("current");
        jQuery(".um-account-side li a[data-tab=" + a + "]").addClass("current");
        return false
    })
});