...
(function ($, window, document) {
    ...
    var $window = $(window),
            ...
            animateScroll = {
                ...
                check: function (target) {
                    ...
                    return (vTop < elBottom && elBottom < vBottom) || (vTop < elTop && elTop < vBottom) ? 'reverse' : '';
                },
    ...
    $.fn.animateScroll = function (options) {
        ...
        var defaults = {
            transformPerspective: 1000000, // Parent Transform Perspective
