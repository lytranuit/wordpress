 ...
 * @package Hamza Lite
 */
add_action('widgets_init', 'hamza_lite_register_slider_post_widget');

function hamza_lite_register_slider_post_widget() {
    register_widget('hamza_lite_slider_post');
}

class Hamza_Lite_Slider_Post extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'hamza_lite_slider_post', __('Silder dự án', 'hamza-lite'), array(
            'description' => __('Dự án', 'hamza-lite')
                )
        );
    }
